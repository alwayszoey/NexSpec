              ...
              <div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
                ...
                <div className="w-full lg:w-1/2 flex flex-col">
                  ...
                  {selectedItem.warning && (
                    <div className="text-red-500 border-l-4 border-red-500/50 bg-red-500/10 p-4 rounded-[12px] sm:rounded-[16px] flex gap-3 mb-6">
                  ...
                  {selectedItem.downloadLinks && selectedItem.downloadLinks.length > 0 ? (
                    <div className="flex flex-col gap-3">
                      <h3 className="text-[14px] font-semibold text-text-main">{t('downloadVersion')}</h3>
